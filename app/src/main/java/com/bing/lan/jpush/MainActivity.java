...
import com.bing.lan.jpush.receiver.JPushReceiver1;
...
public class MainActivity extends AppCompatActivity implements JPushReceiver1.JPushListener {
    ...
    private BroadcastReceiver mIntentReceiver = new JPushReceiver1(this);
    private static final String TAG = "jpush";

    @Override
    public void onReceive(Context context, Intent intent) {
        Log.i(TAG, "11111-------------111111111111----------");
    ...
    private void onHandlerReceive(Context context, Intent intent) {
        ...
        mTextView.setText(printBundle(bundle));
